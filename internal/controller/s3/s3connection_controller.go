...
//+kubebuilder:rbac:groups=s3.zncdata.dev,resources=s3connections,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=s3.zncdata.dev,resources=s3connections/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=s3.zncdata.dev,resources=s3connections/finalizers,verbs=update
