...
//+kubebuilder:rbac:groups=s3.zncdata.dev,resources=s3buckets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=s3.zncdata.dev,resources=s3buckets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=s3.zncdata.dev,resources=s3buckets/finalizers,verbs=update
