...
//+kubebuilder:rbac:groups=database.zncdata.dev,resources=databaseconnections,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=database.zncdata.dev,resources=databaseconnections/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=database.zncdata.dev,resources=databaseconnections/finalizers,verbs=update
...
func (r *DatabaseConnectionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&databasev1alpha1.DatabaseConnection{}).
		Complete(r)
}
